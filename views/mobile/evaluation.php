...
<div class='bbcontainer'>
  <a class='backButton' href=<?php echo $linkout;?> ><button class="buttonLink"><span class="glyphicon glyphicon-arrow-left"></span> Back</button></a>
</div>
...
<?php
  ...
  echo "<br><input class='buttonLink evalsubmit' type='submit' value='Submit Evaluation'>";
