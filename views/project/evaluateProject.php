...
echo "</div>
      <div class='evaluate' id='".$a->id."'>
        ...
        foreach($a->criterias as $c)
        {
          ...
          echo "<input class='standard criteriaRatingout' name ='x' id='".$c->id."' value='".((int)$c->maxRange/2)."'><br>";
        ...
        echo "<input class='standard' onclick='SubmitEvaluation()' type='button' value='Submit Evaluation'>
